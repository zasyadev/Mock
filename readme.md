...
- create .env file and fill-up the configuration required (database credentials, mail crendentials) -- for reference use .env.example
...
- php artisan storage:link for link storage
